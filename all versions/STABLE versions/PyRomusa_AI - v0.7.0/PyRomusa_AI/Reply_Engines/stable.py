...
def use_engine(bot_instance, prompt: str, 
    ...
    if with_memory == True:
                ...
                last_user_words = set(str(bot_instance.last_user_prompt).lower().split()) if getattr(bot_instance, 'last_user_prompt', None) else set()
                last_bot_words = set(str(bot_instance.last_bot_output).lower().split()) if getattr(bot_instance, 'last_bot_output', None) else set()
